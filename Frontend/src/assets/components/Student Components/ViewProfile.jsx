          ...
          <div className="flex justify-between items-start pt-4">
            <div className="grid grid-cols-2 gap-x-5 gap-y-4 pt-3 ">
              <div className="flex items-center w-full">
                ...
                <span className="ml-2 border-2 border-grey-200 w-56 p-2 rounded-lg">
                  {data.firstName}
                </span>
              </div>
              <div className="flex items-center w-full">
                <span className="font-medium w-1/4">Last Name:</span>
                <span className="ml-2 border-2 border-grey-200 w-3/4 p-2 rounded-lg">
                  {data.lastName}
                </span>
              </div>
              ...
              <div className="flex items-center w-full">
                <span className="font-medium w-1/4">Enrollment No:</span>
                <span className="ml-2 border-2 border-grey-200 w-3/4 p-2 rounded-lg">
                  {user.enrollment_Number}
                </span>
              </div>
            </div>
            <div className="flex items-end mr-14">
              <img
                src={user.profile}
                alt="Profile Image"
                className="w-40 h-40 rounded-lg shadow-lg border-2 border-grey-200 p-2"
              />
            </div>
          </div>
          <div className="grid grid-cols-3 gap-x-5 gap-y-3 pb-4 mt-2">
            <div className="flex items-center w-full">
              <span className="font-medium w-1/4">Class:</span>
              <span className="ml-2 border-2 border-grey-200 w-3/4 p-2 rounded-lg">
                {user.Class}
              </span>
            </div>
            <div className="flex items-center w-full">
              <span className="font-medium w-1/4">Section:</span>
              <span className="ml-2 border-2 border-grey-200 w-3/4 p-2 rounded-lg">
                {user.section}
              </span>
            </div>
